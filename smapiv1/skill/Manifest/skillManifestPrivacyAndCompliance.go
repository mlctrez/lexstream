...
type SkillManifestPrivacyAndCompliance struct {
	...
	IsExportCompliant bool `json,omitempty:"isExportCompliant"`
	// True if the skill contains advertising false otherwise.
	ContainsAds bool `json,omitempty:"containsAds"`
	...
	UsesHealthInfo bool `json,omitempty:"usesHealthInfo"`
}

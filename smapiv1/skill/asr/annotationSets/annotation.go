...
type Annotation struct {
	...
	UploadId string `json,omitempty:"uploadId"`
	...
	FilePathInUpload string `json,omitempty:"filePathInUpload"`
	/*
	...
	*/
	EvaluationWeight int `json,omitempty:"evaluationWeight"`
	...
	ExpectedTranscription string `json,omitempty:"expectedTranscription"`
}
